...
public class TVTable3Script : MonoBehaviour
{
    ...
    public void OnMouseDown(){
        ...
        GameObject.Find("DrawingOptions").GetComponent<SelectDrawingRoomModelScript1>().tvTable3Button.GetComponent<LeanTwistRotateAxis>().enabled = true;
        GameObject.Find("DrawingOptions").GetComponent<SelectDrawingRoomModelScript1>().tvTable3SpawnPos = GameObject.Find("DrawingOptions").GetComponent<SelectDrawingRoomModelScript1>().tvTable3.transform.position;

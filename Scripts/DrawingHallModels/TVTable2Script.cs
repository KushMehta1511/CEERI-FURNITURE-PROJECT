...
public class TVTable2Script : MonoBehaviour
{
    ...
    public void OnMouseDown(){
        ...
        GameObject.Find("DrawingOptions").GetComponent<SelectDrawingRoomModelScript1>().tvTable2Button.GetComponent<LeanTwistRotateAxis>().enabled = true;
        GameObject.Find("DrawingOptions").GetComponent<SelectDrawingRoomModelScript1>().tvTable2SpawnPos = GameObject.Find("DrawingOptions").GetComponent<SelectDrawingRoomModelScript1>().tvTable2.transform.position;

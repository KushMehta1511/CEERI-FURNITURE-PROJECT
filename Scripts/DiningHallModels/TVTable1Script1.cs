...
public class TVTable1Script1 : MonoBehaviour
{
    ...
    public void OnMouseDown(){
        ...
        GameObject.Find("DrawingOptions1").GetComponent<SelectDrawingRoomModelScript>().tvTable1Button.GetComponent<LeanTwistRotateAxis>().enabled = true;
        GameObject.Find("DrawingOptions1").GetComponent<SelectDrawingRoomModelScript>().tvTable1SpawnPos = GameObject.Find("DrawingOptions1").GetComponent<SelectDrawingRoomModelScript>().tvTable1.transform.position;

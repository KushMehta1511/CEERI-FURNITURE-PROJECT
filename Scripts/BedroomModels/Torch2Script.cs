...
public class Torch2Script : MonoBehaviour
{
    ...
    public void OnMouseDown(){
        ...
        GameObject.Find("BedroomOptions").GetComponent<SelectModelScript>().torch2Button.GetComponent<LeanTwistRotateAxis>().enabled = true;
        GameObject.Find("BedroomOptions").GetComponent<SelectModelScript>().torch2SpawnPos = GameObject.Find("BedroomOptions").GetComponent<SelectModelScript>().torch2.transform.position;

...
public class Torch1Script : MonoBehaviour
{
    ...
    public void OnMouseDown(){
        ...
        GameObject.Find("BedroomOptions").GetComponent<SelectModelScript>().torch1Button.GetComponent<LeanTwistRotateAxis>().enabled = true;
        GameObject.Find("BedroomOptions").GetComponent<SelectModelScript>().torch1SpawnPos = GameObject.Find("BedroomOptions").GetComponent<SelectModelScript>().torch1.transform.position;

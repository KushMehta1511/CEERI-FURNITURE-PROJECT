...
public class Bed3Script : MonoBehaviour
{
    ...
    public void OnMouseDown(){
        ...
        GameObject.Find("BedroomOptions").GetComponent<SelectModelScript>().bed3Button.GetComponent<LeanTwistRotateAxis>().enabled = true;
        GameObject.Find("BedroomOptions").GetComponent<SelectModelScript>().bed3SpawnPos = GameObject.Find("BedroomOptions").GetComponent<SelectModelScript>().bed3.transform.position;
